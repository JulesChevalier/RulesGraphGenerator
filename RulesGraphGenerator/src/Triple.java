...
public class Triple {
     ...
     *            Code of the object
     */
    public Triple(final int s, final int p, final int o) {
        super();
        this.s = s;
        this.p = p;
        this.o = o;
    ...
    public int nonUniversalConcepts() {
        int nuc = 0;
        final int uni = RulesList.UNIVERSAL;
        if (this.s != uni) {
            nuc++;
        }
        if (this.p != uni) {
     ...
     *         this triple
     */
    public boolean isValidWith(final int[] concepts) {
        if (this.isUniversal()) {
            return true;
        }
        int finded = 0;
        for (final int concept : concepts) {
            if ((this.s == concept) || (this.p == concept) || (this.o == concept)) {
                finded++;
            }
        }
    ...
    /**
     * @param in
     *            Triple to be checked with
     * @param acceptUniversal
     *            True if universal match are accepted, False else
     * @return true if this triple is compatible with 'in'
     */
    public boolean matchWith(final Triple in, final boolean acceptUniversal) {
        if (acceptUniversal && (this.isUniversal() || in.isUniversal())) {
            return true;
        }
        final int s1 = this.s, s2 = in.s, p1 = this.p, p2 = in.p, o1 = this.o, o2 = in.o;
        final int uni = RulesList.UNIVERSAL;
        if (((s1 == uni) || (s2 == uni) || (s1 == s2)) && (p1 == p2) && ((o1 == uni) || (o2 == uni) || (o1 == o2))) {
            return true;
        }
        return false;
    }
