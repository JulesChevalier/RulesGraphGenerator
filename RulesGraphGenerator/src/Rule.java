...
public class Rule {
	 ...
	 * Class constructor
	 * 
	 * @param code Code of the rule in the name map
	 * @param in List of input triples in the following format :
	 * 				s p o s p o... where s p and o are integers
	 * @param out List of output triples with the same format
	 * @throws Exception Throws an exception if input or output 
	...
	/**
	 * @param concepts List of concepts used
	 ...
	 * @return true if the output of this rule match with the input of the parameter rule
	 */
